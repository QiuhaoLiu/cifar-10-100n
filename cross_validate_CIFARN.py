...
parser.add_argument('--n_epoch', type=int, default=120, help='number of epochs for training each fold')
parser.add_argument('--seed', type=int, default=0)
parser.add_argument('--num_workers', type=int, default=4)
parser.add_argument('--k_folds', type=int, default=5, help='number of folds for cross-validation')
parser.add_argument('--output_dir_prob', type=str, default='./cross_validated_predicted_probabilities', help='directory to save predicted probabilities')
parser.add_argument('--output_dir_label', type=str, default='./cross_validated_predicted_labels', help='directory to save predicted labels')
def main(args):
